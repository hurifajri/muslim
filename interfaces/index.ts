...
export type { default as iHome } from '@interfaces/i-home';
export type { default as iIf } from '@interfaces/i-if';
export type { default as iLayout } from '@interfaces/i-layout';
export type { default as iQuote } from '@interfaces/i-quote';
